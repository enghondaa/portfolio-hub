...
export function PersistenceBanner() {
  if (isPersistent) {
    return (
      <div className="flex items-center gap-2.5 rounded-2xl border border-[var(--color-success)]/30 bg-[var(--color-success)]/10 px-4 py-3 font-mono text-xs text-[var(--color-success)]">
