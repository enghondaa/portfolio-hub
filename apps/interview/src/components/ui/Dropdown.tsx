 ...
 *
 * Copied from the Task Board rather than shared, because the two apps style it
 * differently and lifting it into @portfolio/ui would mean either a props
 * explosion or a component that looks wrong in one of them.
 */
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex w-full items-center justify-between gap-2.5 rounded-xl border border-[var(--color-neutral-200)] bg-[var(--color-neutral-50)] px-3.5 py-2.5 text-sm text-[var(--color-neutral-700)] transition-colors duration-200 hover:border-[var(--color-accent)]/50 focus-visible:outline-none focus-visible:border-[var(--color-accent)] focus-visible:shadow-[0_0_0_3px_var(--color-accent-soft)]"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.ul
            ...
            className="absolute right-0 z-50 mt-2 min-w-full overflow-hidden rounded-xl border border-[var(--color-neutral-200)] bg-[var(--color-neutral-50)] p-1 shadow-[0_20px_45px_-15px_rgba(0,0,0,0.55)] focus:outline-none"
          >
